...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAnyException(Throwable ex, NativeWebRequest request) {
        if(ex instanceof RlCrmException){
            ErrorCodes errorCodes = new ErrorCodes(((RlCrmException) ex).getCode(), ex.getMessage(), null);
            return new ResponseEntity(errorCodes, buildHeaders(ex), HttpStatusCode.valueOf(((RlCrmException) ex).getCode()));
        }
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.rlabs.crm");
    }
}
