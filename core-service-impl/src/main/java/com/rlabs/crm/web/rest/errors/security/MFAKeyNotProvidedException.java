...
public class MFAKeyNotProvidedException extends RlCrmException {

    private static ErrorCodes errorCodes = ErrorCodeCache.get("mfa-key.not.provided");
    public MFAKeyNotProvidedException(){
