...
public class OTPAuthenticationFailureException extends RlCrmException {

    private static ErrorCodes errorCodes = ErrorCodeCache.get("OTP.authentication.failure");
    public OTPAuthenticationFailureException(){
