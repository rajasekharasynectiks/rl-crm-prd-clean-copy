...
public class RoleNotProvidedException extends RlCrmException {

    private static ErrorCodes errorCodes = ErrorCodeCache.get("role.not.provided");
    public RoleNotProvidedException(){
