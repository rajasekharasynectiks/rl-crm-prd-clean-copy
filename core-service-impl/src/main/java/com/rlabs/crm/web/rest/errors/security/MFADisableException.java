...
public class MFADisableException extends RlCrmException {

    private static ErrorCodes errorCodes = ErrorCodeCache.get("disabling.mfa.failed");
    public MFADisableException(){
